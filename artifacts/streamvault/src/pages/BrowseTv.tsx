...
export function BrowseTv() {
  ...
  const { data: shows, isLoading } = useDiscoverTv(
    ...
    { query: { queryKey: getDiscoverTvQueryKey({ genreId: selectedGenre, sortBy, page }) } }
  );

  const totalPages = Math.min(shows?.total_pages ?? 1, 500);
    ...
    <div className="min-h-screen bg-background text-foreground pb-20">
      ...
      <div className="pt-28 px-5 md:px-10 max-w-screen-2xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <h1 className="font-display text-5xl md:text-6xl text-white tracking-widest">TV Shows</h1>
        </div>
